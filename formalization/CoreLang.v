...
Global Hint Constructors primop: core.
...
| treturn (v: value)
| tlete (e1: tm) (e2: tm)
| tletprimop (op: primop) (v1: value) (e: tm)
...
with open_tm (k : nat) (s : value) (e : tm): tm :=
       ...
       | tletprimop op v1 e =>
           tletprimop op (open_value k s v1) (open_tm (S k) s e)
...
with close_tm (x : atom) (s : nat) (e : tm): tm :=
       ...
       | tletprimop op v1 e =>
           tletprimop op (close_value x s v1) (close_tm x (S s) e)
       | tmatchb v e1 e2 =>
...
| lc_tletprimop: forall op (v1: value) e (L: aset),
    lc v1 -> (forall (x: atom), x ∉ L -> lc (e ^t^ x)) -> lc (tletprimop op v1 e)
...
with fv_tm (e : tm): aset :=
       ...
       | tletprimop op v1 e => (fv_value v1) ∪ (fv_tm e)
...
with tm_subst (x : atom) (s : value) (e : tm): tm :=
       ...
       | tletprimop op v1 e => tletprimop op (value_subst x s v1) (tm_subst x s e)
